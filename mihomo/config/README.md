...
|---------|------|--------|---------|----------|
| `MihomoPro.yaml` | v26.1.1 | ⭐⭐⭐⭐⭐ | 专业用户，需要全功能支持 | 22.6 KB |
| `OneSmartPro.yaml` | v26.1.1 | ⭐⭐⭐⭐ | 高级用户，智能代理 + 多端口 | 20.1 KB |
| `OneSmart.yaml` | v26.1.1 | ⭐⭐⭐ | 普通用户，智能代理极简版 | 12.5 KB |
| `OneTouch.yaml` | v26.1.1 | ⭐⭐ | 新手用户，一键连纯净版 | 12.4 KB |
