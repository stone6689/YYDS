...
|---------|------|--------|---------|----------|
| `MihomoPro.yaml` | v26.1.0 | ⭐⭐⭐⭐⭐ | 专业用户，需要全功能支持 | 24.8 KB |
| `OneSmartPro.yaml` | v26.1.0 | ⭐⭐⭐⭐ | 高级用户，智能代理 + 多端口 | 21.9 KB |
| `OneSmart.yaml` | v26.1.0 | ⭐⭐⭐ | 普通用户，智能代理极简版 | 13.4 KB |
| `OneTouch.yaml` | v26.1.0 | ⭐⭐ | 新手用户，一键连纯净版 | 13.4 KB |
